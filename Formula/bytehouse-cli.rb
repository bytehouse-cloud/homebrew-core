class BytehouseCli < Formula
  ...
  url "https://github.com/bytehouse-cloud/cli/releases/download/v1.5.6.2/bytehouse-v1.5.6.2-darwin-amd64"
  ...
  def install
    File.rename("bytehouse-v1.5.6.2-darwin-amd64", "bytehouse-cli")
